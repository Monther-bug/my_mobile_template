...
mixin _$AuthState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function()? initial,
    TResult Function()? loading,
    TResult Function(UserEntity user, String accessToken, String? refreshToken)?
        authenticated,
    TResult Function(String? message)? unauthenticated,
    TResult Function(String message, Object? error)? error,
...
abstract class _$$AuthAuthenticatedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({UserEntity user, String accessToken, String? refreshToken});
...
class _$AuthAuthenticatedImpl implements AuthAuthenticated {
  const _$AuthAuthenticatedImpl(
      {required this.user, required this.accessToken, this.refreshToken});
...
abstract class AuthAuthenticated implements AuthState {
  const factory AuthAuthenticated(
      ...
      final String? refreshToken}) = _$AuthAuthenticatedImpl;
...
class _$AuthErrorImpl implements AuthError {
  const _$AuthErrorImpl({required this.message, this.error});
...
abstract class AuthError implements AuthState {
  const factory AuthError(
      {required final String message, final Object? error}) = _$AuthErrorImpl;
